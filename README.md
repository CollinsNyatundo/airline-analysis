...
1. **Interactive Dashboard Development**: Create a live dashboard that allows stakeholders to filter and explore safety metrics by region, aircraft type, time period, and weather conditions to support data-driven decision-making. [Explore the Tableau dashboard here](https://public.tableau.com/shared/C46W9R9FN?:display_count=n&:origin=viz_share_link)
